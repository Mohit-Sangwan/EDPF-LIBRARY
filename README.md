...
src/          Edpf.Abstractions (contracts, zero deps) · Edpf.Core (shared
              ...
              Edpf.Barcode (GS1 traceability encoding)
...
| [Architecture decisions](docs/adr/README.md) | The twenty-seven binding decisions, each with its revisit triggers |
